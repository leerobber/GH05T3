...
RESULTS = []
_ORIG_CWD = _BACKEND  # chdir target for tests that need backend/ as cwd

def record(name, passed, detail=""):
    status = "PASS" if passed else "FAIL"
    RESULTS.append({"test": name, "status": status, "detail": detail})
    icon = "âœ“" if passed else "âœ—"
    print(f"  {icon} [{status}] {name}" + (f" â€” {detail}" if detail else ""))
...
# 1. SYNTAX / COMPILE CHECK â€” every .py in backend/
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
section("1. SYNTAX COMPILATION CHECK")
import py_compile

BACKEND = _BACKEND  # always C:\...\GH05T3\backend â€” resolved at top via _BACKEND
    ...
    try:
        ...
        if any(dep in missing_mod for dep in OPTIONAL_DEPS):
            record(f"import:{mod_path}", True,
                   f"SKIPPED â€” dep '{missing_mod}' not in CI Python (in requirements.txt)")
        else:
...
try:
    ...
    # NoLLMError raised when no keys/local providers configured.
    #
    # ghost_llm._env_key() re-reads the .env file on every call (hot-reload for
    # runtime key injection), so os.environ.pop() alone is not enough â€” the key
    # comes back from disk. We also patch _env_key to return "" so every
    # provider fails the key-present check.  Local services are pointed at a
    # dead port (19999) so their availability checks time out instantly.
    from unittest.mock import patch as _patch
    _dead = "http://127.0.0.1:19999"
    _dead_env = {
        "OLLAMA_GATEWAY_URL": _dead,
        "SOVEREIGN_CORE_URL": _dead,
        "GH05T3_MODEL_URL":   _dead,
        "LEMONADE_URL":       _dead,
    }
    for _k, _v in _dead_env.items():
        os.environ[_k] = _v
    try:
        import sovereign_economy as _sov_mod
        _sov_mod._BASE_URL = None   # bust cached URL
    except Exception:
        pass
    ...
    # Restore live env so nothing downstream is broken
    for _k in _dead_env:
        os.environ.pop(_k, None)
    try:
        import sovereign_economy as _sov_mod
        _sov_mod._BASE_URL = None
    except Exception:
        pass
...
with tempfile.TemporaryDirectory(ignore_cleanup_errors=True) as tmpdir:
    ...
    # Persistence â€” log file written
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# 7. SWARM AGENTS â€” all 5 specialists
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def run_security_tests():
    ...
    record("security:clean input passes â€” returns None", result is None,
           f"result={result!r}")
...
for sec, counts in sections.items():
    ...
    bar = "â–ˆ" * counts["pass"] + "â–‘" * counts["fail"]
    print(f"    {sec:30s} {counts['pass']:2d}/{t:2d}  {bar}")

print(f"\n{'='*60}\n")


# â”€â”€ Pytest entry point â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def test_advanced_training_subsystems():
    ...
    assert RESULTS, "No subsystem checks were recorded â€” something went wrong at module load"
