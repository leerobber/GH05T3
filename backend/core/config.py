...
BACKENDS = {
    "primary":  os.environ.get("VLLM_PRIMARY_URL",    "http://localhost:8001"),
    "verifier": os.environ.get("LLAMA_VERIFIER_URL",  "http://localhost:8002"),
    "fallback":  os.environ.get("LLAMA_FALLBACK_URL", "http://localhost:8003"),
}
