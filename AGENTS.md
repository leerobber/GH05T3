...
GH05T3/
  ...
  native/
    ...
    android/
      termux_setup.sh   Termux/Android node setup (Codex pinned v2.1.112)
...
| 8002  | gateway_v3 (SwarmBus · Codex · GitHub · Stripe · Story Editor · Lemonade) |
...
- Codex pinned to v2.1.112 (last Termux-compatible)
...
## Active branch
`Codex/fix-multi-gpu-training-2WHKH` — all current work lives here.
